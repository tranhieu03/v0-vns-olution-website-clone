        ...
        <div className="mx-auto max-w-3xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/15 backdrop-blur-sm px-4 py-2 mb-6">
            ...
            <span className="text-sm font-medium text-white">
              Bảng giá linh hoạt cho mọi doanh nghiệp
            </span>
          </div>
          ...
          <p className="mt-6 text-lg text-sky-100/90 leading-relaxed max-w-2xl mx-auto">
            VNSolution cung cấp các gói giải pháp linh hoạt, phù hợp với mọi quy mô doanh nghiệp. 
            Từ startup đến tập đoàn lớn, chúng tôi có giải pháp dành riêng cho bạn.
          </p>
        </div>
      </div>
    </section>
